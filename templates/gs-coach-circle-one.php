				...
				<div class="single-member--wrapper" itemscope itemtype="http://schema.org/Organization">
					...
					<div class="single-member">
						...
						<div class="gs_coach_image__wrapper">
							<?php member_thumbnail_custom( $gs_coach_thumbnail_sizes, $id, $gs_coach_name_is_linked == 'on', $gs_coach_link_type, true ); ?>
							<?php 
								if( $gs_coach_name_is_linked == 'off' ){
									echo '<div class="gs_coach_image__overlay"></div>';
								} 
							?>
						</div>
