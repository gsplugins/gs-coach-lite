...
$gs_member_name    = getoption( 'gs_member_name', 'on' );
$gs_member_role    = getoption( 'gs_member_role', 'on' );
$gs_member_connect = getoption( 'gs_member_connect', 'on' );
$gs_member_name_is_linked = getoption( 'gs_member_name_is_linked', 'on' );
