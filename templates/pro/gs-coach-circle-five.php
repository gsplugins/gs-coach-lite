							...
							<div class="single-mem-desc-social">
								...
								<?php if ( 'on' ==  $gs_member_details ) : ?>
									...
									<?php if ( 'on' === $gs_desc_allow_html ) : ?>
										<div class="gs-member-desc gs-coach--scrollbar" itemprop="description"><?php echo wpautop( do_shortcode( get_the_content() ) ); ?></div>
									<?php else : ?>
										<p class="gs-member-desc gs-coach--scrollbar" itemprop="description"><?php member_description( $id, $gs_tm_details_contl, true, true, $gs_member_name_is_linked == 'on', $gs_member_link_type ); ?></p>
									<?php endif; ?>
