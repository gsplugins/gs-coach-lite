						...
						<div class="gs_coach_image__wrapper">
							...
							<div class="single-mem-desc-social">
								...
								<?php if ( 'on' ==  $gs_coach_details ) : ?>
									...
									<?php else : ?>
										<p class="gs-member-desc gs-coach--scrollbar" itemprop="description"><?php member_description( $id, $gs_tm_details_contl, true, true, $gs_coach_name_is_linked == 'on', $gs_coach_link_type ); ?></p>
									<?php endif; ?>
