...
namespace GSCOACH;
/**
 * GS Coach - Layout Navigation
 * @author GS Plugins <hello@gsplugins.com>
 * 
 * This template can be overridden by copying it to yourtheme/gs-coach/partials/gs-coach-layout-navigation.php
 * 
...
do_action( 'gs_coach_after_navigation' );