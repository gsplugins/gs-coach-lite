...
class Integration_Divi {
    ...
    public function editor_style() {
        ...
        <style>
            ...
            .et-db #et-boc .et-l .et-fb-modules-list ul > li.gs_coach_members:before {
            ...
            .et-db #et-boc .et-l .et-fb-modules-list ul > li.gs_coach_members {
                height: 67px;
            }
